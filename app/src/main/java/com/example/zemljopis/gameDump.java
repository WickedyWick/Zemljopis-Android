...
//            mainLeft.addView(lblLocal);
        ...
        public void call(Object... args) {
            ...
            try {
                if(result.getBoolean("Success")){
                    Snackbar.make(findViewById(R.id.gameCoordinatorID),"Izbacivanje za igrača : "+ result.getString("username"),Snackbar.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
...
/*
            ...
            try {
                if(result.getBoolean("Success")){
                    ...
                    if(result.getBoolean("roundActive")){
                        ...
                        Snackbar.make(findViewById(R.id.gameCoordinatorID),"Runda u toku! Sačekajte kraj!",Snackbar.LENGTH_SHORT).show();
                    }
                }else{
        ...
        @Override
        public void call(Object... args) {
            Snackbar.make(findViewById(R.id.gameCoordinatorID),"Doslo je do problema prilikom unosenja podataka, podaci nevažeci!",Snackbar.LENGTH_LONG).show();
        }
    });
        ...
        public void call(Object... args) {
            ...
            try {
                if(result.getBoolean("Success")){
                    ...
                    Snackbar.make(findViewById(R.id.gameCoordinatorID),"Igra počinje!", Snackbar.LENGTH_SHORT).show();
                    runOnUiThread(new Runnable() {
        ...
        public void call(Object... args){
            ...
            try {
                if(!result.getBoolean("Success")){
                    ...
                    Snackbar.make(findViewById(R.id.gameCoordinatorID),"Evaluacija završena",Snackbar.LENGTH_SHORT).show();
                    for(int i=0;i<fields.length;i++){
                        try{
